<template>
    <el-row class="swifcema-header">
      <el-col :span="4">
        <div class="nav-logo">
          <router-link to="/" class="nav-logo-link">
            <img :src="appVars.images_url + '/logo.png'" />
          </router-link>
        </div>
      </el-col>
      ...
      <el-col :span="16">
        <el-menu
          :router="true"
          mode="horizontal"
          class="swifcema-navigation"
          :default-active="active"
        >
          <el-menu-item class="el-menu-item" v-if="this.appVars.is_onboarded === 'no'">
            <router-link to="/setup_template" class="swifcema-menu-link">
          ...
          <el-menu-item class="el-menu-item" v-for="item in items" :key="item.route">
            <router-link :to="item.route" class="swifcema-menu-link">
      ...
      <!-- Pro Button -->
      <el-col :span="4">
        <div class="swifcema-nav-pro-btn" v-if="!hasPro">
          <a href="https://swiftcertificate.com/" class="nav-logo-link" target="_blank">
            <el-button class="swifcema-pro-btn">
