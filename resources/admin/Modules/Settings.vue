<template>
  <div class="swifcema-settings-wrap">
      <div class="header">
       ...
       <div class="swifcema-card">
        ...
        <div class="settings-item">
          ...
          <div class="setting-form">
            ...
            <el-input type="text" placeholder="Enter amount ex: 10"></el-input>
          </div>
        </div>
        ...
        <div class="settings-item">
          ...
          <div class="setting-form">
             ...
             <div class="setting-copy-field">
               <el-input type="text" placeholder="Enter student name" disabled></el-input>
          ...
          <div class="setting-form">
            ...
            <div class="setting-copy-field">
              <el-input type="text" placeholder="verify url" disabled></el-input>
              <el-tooltip effect="dark"
                          content="Click To Copy"
                          title="Click To Copy"
                          placement="top">
          ...
          <div class="setting-form">
            ...
            <div class="setting-copy-field">
              <el-input type="text" placeholder="Enter order url" disabled></el-input>
              <el-tooltip effect="dark"
                          content="Click To Copy"
                          title="Click To Copy"
                          placement="top">
          ...
          <div class="setting-form">
            ...
            <el-input type="text" placeholder="Enter certificate code prefix"></el-input>
          </div>
          <div class="setting-form">
            <h4 class="label">Clear Cache</h4>
            <el-checkbox class="swifcema_checkbox" true-label="yes" false-label="no" label="Clearing for whole cache"></el-checkbox>
          </div>
        </div>
        ...
        <div class="settings-item">
          ...
          <div class="setting-form">
            ...
            <div class="swifcema-socia-icon">
              <a class="swifcema-twitter" href="#">
              ...
              <a class="swifcema-facebook" href="#">
              ...
              <a class="swifcema-instagram" href="#">
          ...
          <div class="setting-form">
            ...
            <a class="swifcema-wordpress-icon" href="#">
        ...
        <div class="settings-item">
          <div class="swifcema_action_btn">
            <el-button class="swifcema-primary-btn svg-span-btn">
