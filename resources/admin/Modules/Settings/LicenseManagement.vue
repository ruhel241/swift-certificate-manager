<template>
    <div class="wpsc-card">
        <div class="settings-item">
            ...
            <div class="wpsc-license-management">
                <div v-loading="verifying" class="wscm_pad_around">
                    ...
                    <div v-else class="wscm_narrow_box" :class="'wscm_license_'+licenseData.status">
                        <div class="wpsc-expired" v-if="licenseData.status == 'expired'">
                            ...
                            <div v-else>
                                ...
                                <!-- <div class="wpsc-provide-license-key">
                        ...
                        <div class="wpsc-valid" v-else-if="licenseData.status == 'valid'">
                        ...
                        <div class="wpsc-provide-license-key" v-else>
...
export default {
    ...
    methods: {
        getLicense() {
            ...
            this.fetching = true;
            this.$get({
                action: "swift_certificate_manager_admin_license_ajax",
