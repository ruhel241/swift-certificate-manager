<template>
  <div class="scm-settings-wrap">
      ...
      <div class="scm-card" v-if="settingTabMenu === 'general'" v-loading="fetching">
        ...
        <div class="settings-item">
          ...
          <div class="setting-form">
            ...
            <el-checkbox v-model="settings.clear_cache" class="scm_checkbox" true-label="yes" false-label="no" label="Clearing for whole cache"></el-checkbox>
          </div>
        </div>
        ...
        <div class="settings-item">
          ...
          <div class="setting-form">
            ...
            <div class="scm-socia-icon">
              <a class="scm-twitter" href="#">
          ...
          <div class="setting-form">
            ...
            <a class="scm-wordpress-icon" href="#">
      ...
      <div class="scm-card" v-if="settingTabMenu === 'payment_methods'">
        <div class="settings-item">
          <div class="header-title">
...
export default {
  ...
  data() {
    return {
      fetching: false,
      saving: false,
      settingTabMenu: localStorage.getItem('scm_active_menu_settings') || 'general',
      // activeSettings:
      activeName: localStorage.getItem('scm_active_payment_method') || 'stripe',
  ...
  methods: {
    ...
    handleClick(tab, event) {
      localStorage.setItem('scm_active_payment_method', this.activeName)
    },
   
    settingTabChangeHandler(val) {
      localStorage.setItem('scm_active_menu_settings', val)
    },
   
    getSettings(){
      this.fetching = true;
      this.$post({
        action: "scm_global_settings_admin_ajax",
        route: "get_settings",
