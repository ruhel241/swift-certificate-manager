<template>
  <div class="swiftcm-settings-wrap">
      <div class="header">
      ...
      <div class="swiftcm-card" v-if="settingTabMenu === 'general'" v-loading="fetching">
        ...
        <div class="settings-item">
          ...
          <div class="setting-form">
            ...
            <el-checkbox v-model="settings.clear_cache" class="swiftcm_checkbox" true-label="yes" false-label="no" label="Clearing for whole cache"></el-checkbox>
          </div>
        </div>
        ...
        <div class="settings-item">
          ...
          <div class="setting-form">
            ...
            <div class="swiftcm-socia-icon">
              <a class="swiftcm-twitter" href="#">
              ...
              <a class="swiftcm-instagram" href="#">
          ...
          <div class="setting-form">
            ...
            <a class="swiftcm-wordpress-icon" href="#">
      ...
      <div class="swiftcm-card" v-if="settingTabMenu === 'payment_methods'">
        <div class="settings-item">
          <div class="header-title">
...
export default {
  ...
  data() {
    return {
      fetching: false,
      saving: false,
      settingTabMenu: localStorage.getItem('swiftcm_active_menu_settings') || 'general',
      // activeSettings:
      activeName: localStorage.getItem('swiftcm_active_payment_method') || 'stripe',
      currencies: window.swiftcmAdminVars.currencies,
      settings: {
      ...
      hasProVersion: !!window.swiftcmAdminVars.has_pro_version
    };
  },
  methods: {
    // payment methods
    handleClick(tab, event) {
      localStorage.setItem('swiftcm_active_payment_method', this.activeName)
    },
   
    settingTabChangeHandler(val) {
      localStorage.setItem('swiftcm_active_menu_settings', val)
    },
   
    getSettings(){
      this.fetching = true;
      this.$post({
        action: "swiftcm_global_settings_admin_ajax",
        route: "get_settings",
