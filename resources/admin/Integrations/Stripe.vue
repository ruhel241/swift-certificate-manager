    ...
    <div class="swiftcm_main_container" v-loading="fetching">
        <div class="swiftcm_wrapper swiftcm_payment_settings" v-loading="saving">
          ...
          <div class="payment_item">
              ...
              <el-checkbox class="swiftcm_checkbox" true-label="yes" false-label="no" label="Enable stripe payment method." v-model="settings.enable"></el-checkbox>
          </div>
