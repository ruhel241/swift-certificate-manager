    ...
    <div class="scm_main_container" v-loading="fetching">
        <div class="scm_wrapper swift_certificate_manager_payment_settings" v-loading="saving">
          ...
          <div class="payment_item">
              ...
              <el-checkbox class="scm_checkbox" true-label="yes" false-label="no" label="Enable stripe payment method." v-model="settings.enable"></el-checkbox>
          </div>
