...
use SwiftCertificateManagerFluent\QueryBuilder\Raw;

abstract class BaseAdapter
{
    /**
     * @var \SwiftCertificateManagerFluent\Connection
     */
        ...
        foreach ($statements as $statement) {
            ...
            if (is_null($value) && $key instanceof \Closure) {
                ...
                $nestedCriteria = $this->container->build(
                    '\\SwiftCertificateManagerFluent\\QueryBuilder\\NestedCriteria',
