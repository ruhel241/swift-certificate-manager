<?php namespace SwiftCertificateManagerFluent\QueryBuilder;

use SwiftCertificateManagerFluent\Connection;
use SwiftCertificateManagerFluent\Exception;
...
class QueryBuilderHandler
{
    ...
    /**
     * @var \SwiftCertificateManagerFluent\QueryBuilder\Adapters\BaseAdapter
     */
    ...
    /**
     * @param null|\SwiftCertificateManagerFluent\Connection $connection
     *
     * @throws \SwiftCertificateManagerFluent\Exception
     */
    public function __construct(Connection $connection = null)
    {
        ...
        $this->adapterInstance = $this->container->build(
            '\\SwiftCertificateManagerFluent\\QueryBuilder\\Adapters\\' . ucfirst($this->adapter),
    ...
    public function query($sql, $bindings = array())
    {
        $this->dbStatement = $this->container->build(
            '\\SwiftCertificateManagerFluent\\QueryBuilder\\QueryObject',
            array($sql, $bindings)
        )->getRawSql();
    ...
    public function join($table, $key, $operator = null, $value = null, $type = 'inner')
    {
        ...
        $joinBuilder = $this->container->build('\\SwiftCertificateManagerFluent\\QueryBuilder\\JoinBuilder', array($this->connection));
    ...
    public function transaction(\Closure $callback)
    {
        try {
            ...
            $transaction = $this->container->build(
                '\\SwiftCertificateManagerFluent\\QueryBuilder\\Transaction',
                array($this->connection)
            );
    ...
    {
        return $this->container->build('\\SwiftCertificateManagerFluent\\QueryBuilder\\Raw', array($value, $bindings));
    }
