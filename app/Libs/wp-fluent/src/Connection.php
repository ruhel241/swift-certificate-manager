...
class Connection
{
    ...
    public function __construct($wpdb, array $config = array(), $alias = null, Container $container = null)
    {
        ...
        $this->eventHandler = $this->container->build('\\SwiftCertificateManagerFluent\\EventHandler');
    ...
    {
        class_alias('SwiftCertificateManagerFluent\\AliasFacade', $alias);

        $builder = $this->container->build('\\SwiftCertificateManagerFluent\\QueryBuilder\\QueryBuilderHandler', array($this));
    ...
    {
        return $this->container->build('\\SwiftCertificateManagerFluent\\QueryBuilder\\QueryBuilderHandler', array($this));
    }
